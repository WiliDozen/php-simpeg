...
// query tampil akun utk operator
...
<div id="layoutSidenav_content">
                                ...
                                <tr>
                                    ...
                                    <td width="15%" class="text-center">
                                        <button class="btn btn-success btn-sm mb-1" data-toggle="modal"
                                            data-target="#modalUbah<?= $data['id_akun']; ?>"><i class="fas fa-edit"></i>
                                            Ubah</button>
                                            <?php if ($data['id_akun'] != $id_akun) : ?>
                                        <a href="hapus-akun.php?id_akun=<?= $data['id_akun']; ?>"
                                            class="btn btn-danger btn-sm mb-1"
                                            onclick="return confirm('Yakin Data Akun Akan Dihapus.?');"><i
    ...
    <!-- Modal Ubah -->
    <?php foreach ($akun as $data) : ?>
    <div class="modal fade" id="modalUbah<?= $data['id_akun']; ?>" tabindex="-1" role="dialog"
                ...
                <div class="modal-body">
                    <form action="" method="post">
                        ...
                        <div class="form-group">
                            <label for="no_telepon">No Telepon</label>
                            <input type="number" name="no_telepon" id="no_telepon" class="form-control" required
                                minlength="3" value="<?= $data['no_telepon']; ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="password<?= $data['id_akun']; ?>" class="form-control" minlength="6"
                                required>
                        </div>
