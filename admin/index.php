...
$judul = "WiliDzn"; // $judul menyimpan judul halaman masing-masing

include "layout/header.php";

// ambil seluruh daftar bidang untuk dihitung
$bidang = query("SELECT * FROM bidang");

// ambil data pegawai untuk dihitung
$pegawai = query("SELECT * FROM pegawai");

// ambil data akun untuk dihitung
$akun = query("SELECT * FROM akun");

$pegawai_terbaru = query("SELECT * FROM pegawai ORDER BY id_pegawai DESC LIMIT 0, 2");
            ...
            <div class="container-fluid">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-danger text-white mb-4">
                        <div class="card-body">Download laporan: <?= count($akun); ?></div>
                        <div class="card-footer d-flex align-items-center justify-content-between">
