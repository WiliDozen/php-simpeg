					...
					<form action="" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<select name="jk" id="jk" class="form-control" required>
									<?php $jk = $pegawai['jk']; ?>
									<option value="Laki-Laki" <?= $jk == 'Laki-Laki' ? 'selected' : null ?>>Laki-Laki
									</option>
									<option value="Perempuan" <?= $jk == 'Perempuan' ? 'selected' : null ?>>Perempuan
									</option>
								</select>
							</div>
							...
							<div class="form-group col-sm-6">
								...
								<select name="id_bidang" id="id_bidang" class="form-control">
									...
									<option value="<?= $option['id_bidang'] ?>" selected><?= $option['nama_bidang'] ?>
									</option>
									<?php else : ?>
						...
						<div class="row">
							<div class="form-group col-sm-6">
								...
								<input type="number" name="no_telepon" id="no_telepon" class="form-control" required
									minlength="8" value="<?= $pegawai['no_telepon']; ?>">
							</div>
							...
							<div class="form-group col-sm-6">
								...
								<select name="golongan" id="golongan" class="form-control" required>
									...
									<option value="Kontrak" <?= $golongan == 'Kontrak' ? 'selected' : null ?>>Kontrak
									</option>
						...
						<div class="row">
							...
							<div class="form-group col-sm-6">
								...
								<select name="status" id="status" class="form-control" required>
									...
									<option value="Menikah" <?= $status == 'Menikah' ? 'selected' : null?>>Menikah
									</option>
									<option value="Belum Menikah" <?= $status == 'Belum Menikah' ? 'selected' : null?>>
						...
						<div class="row">
							...
							<div class="form-group col-sm-6">
								...
								<div class="mt-1">
									<img src="assets/img/<?= $pegawai['foto']; ?>" alt=""
						...
						<div class="float-right">
							<button type="submit" name="ubah" class="btn btn-primary"><i class="fas fa-edit"></i>
								Ubah</button>
						</div>
